...
void setLangString(char *curHeader, char *str, char *data)
{
	...
	if(strcmp(curHeader,"Errors") == 0)
	{
		...
		//copyIfMatch(str, "NoId3", data, l_noid3, sizeof(l_noid3));
...
void initLanguage()
{
	...
	strcpy(l_fatalerror, "Fatal Error!  DSOrganize has run out of memory.  Please email DragonMinded at shaun.taylor@gmail.com and let him know what you were trying to do when DSOrganize failed.");
	strcpy(l_fatalirc, "Fatal Error!  There is no room in the command buffer for new commands.  Please email DragonMinded at shaun.taylor@gmail.com and let him know what you were trying to do when DSOrganize failed.");
	strcpy(l_outoffiles, "Fatal Error!  DSOrganize has run out of free file handles.  Please email DragonMinded at shaun.taylor@gmail.com and let him know what you were trying to do when DSOrganize failed.");
