...
extern MREADER* _mm_new_file_reader(VIRTUAL_FILE* fp);
extern void _mm_delete_file_reader(MREADER*);

extern MWRITER* _mm_new_file_writer(VIRTUAL_FILE *fp);
...
extern VIRTUAL_FILE *_mm_fopen(CHAR*,CHAR*);
extern int	_mm_fclose(VIRTUAL_FILE *);
