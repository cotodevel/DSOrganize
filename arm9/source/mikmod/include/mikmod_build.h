...
MIKMODAPI extern SAMPLE *Sample_LoadFP(VIRTUAL_FILE*);
...
MIKMODAPI extern MODULE* Player_LoadFP(VIRTUAL_FILE*,int,BOOL);
MIKMODAPI extern MODULE* Player_LoadGeneric(MREADER*,int,BOOL);
MIKMODAPI extern CHAR*   Player_LoadTitle(CHAR*);
MIKMODAPI extern CHAR*   Player_LoadTitleFP(VIRTUAL_FILE*);
