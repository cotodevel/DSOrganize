...
void setSoundMultiplicity(u32 mult)
{
...
void fillMadBuffer()
{
	...
	if(Stream.buffer==NULL || Stream.error==MAD_ERROR_BUFLEN)
	{
		...
		ReadSize=DRAGON_fread(ReadStart,ReadSize,1,soundData.filePointer);
...
{	
	...
	if(strcmp(ext, ".669") == 0 || strcmp(ext, ".amf") == 0 || strcmp(ext, ".asy") == 0 || strcmp(ext, ".dsm") == 0 || strcmp(ext, ".far") == 0 || strcmp(ext, ".gdm") == 0 || strcmp(ext, ".gt2") == 0 || strcmp(ext, ".imf") == 0 || strcmp(ext, ".it") == 0  || strcmp(ext, ".m15") == 0 || strcmp(ext, ".med") == 0 || strcmp(ext, ".mod") == 0 || strcmp(ext, ".mtm") == 0 || strcmp(ext, ".okt") == 0 || strcmp(ext, ".s3m") == 0 || strcmp(ext, ".stm") == 0 || strcmp(ext, ".stx") == 0 || strcmp(ext, ".ult") == 0 || strcmp(ext, ".uni") == 0 || strcmp(ext, ".xm") == 0)
	{
		// tracker file!
...
void setSoundLoc(u32 loc)
{
	...
	switch(soundData.sourceFmt)
	{
		...
		case SRC_FLAC:
			...
			if(DRAGON_isCached(soundData.filePointer))
			{
				DRAGON_cacheLoop();
			}
			break;			
