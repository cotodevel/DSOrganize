/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: assembly.h,v 1.8 2006/07/19 14:19:27 damann Exp $
 *
 ...
 */
#elif (defined (__arm) && defined (__ARMCC_VERSION)) || defined(HELIX_CONFIG_SYMBIAN_GENERATE_MMP)
