...
extern int mp_init_multi(mp_int* a, mp_int* b, mp_int* c, mp_int* d, mp_int* e, mp_int* f);
...
extern int  mp_exptmod (mp_int * G, mp_int * X, mp_int * P, mp_int * Y);

extern int  mp_cmp(mp_int *a, mp_int *b);
extern int  mp_cmp_d(mp_int *a, mp_digit b);

extern int  mp_unsigned_bin_size(mp_int * a);
extern int  mp_read_unsigned_bin (mp_int * a, const unsigned char *b, int c);
